...
using HotelReservationAPI.Application.Features.Customers.Queries.GetAll;
using HotelReservationAPI.Application.Features.Customers.Queries.GetById;
using MediatR;
...
namespace HotelReservationAPI.WebAPI.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        {
            var response = await _mediatR.Send(new GetByIdCustomerRequest { Id = id });
            return Ok(response);
        }
